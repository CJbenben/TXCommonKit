...
#define IS_IPHONE_XS_MAX ([UIScreen instancesRespondToSelector:@selector(currentMode)] ? CGSizeEqualToSize(CGSizeMake(1243, 2688), [[UIScreen mainScreen] currentMode].size) : NO)
